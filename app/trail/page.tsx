...
export default function Page() {
	...
	return (
		<div className="flexflex-col items-center justify-center px-2 sm:px-24">
			<Navbar />
			<div className="flex items-center justify-center h-[85vh]">
				<div className="flex items-center justify-center">
					<svg className="text-lime-500" width={472} height={339}>
						<use xlinkHref="/appIcons.svg#sign-up" />
					</svg>
				</div>
							...
							<div id="waitlist" className="pt-20 md:flex">
								<div className="px-4 md:w-2/5">
									<div className="text-center mx-auto lg:mb-10 max-w-[720px]">
										...
										<p className="text-base text-body-color">
											Be the first to know when our EHR SAAS platform launches!
											Sign up below to receive exclusive updates and early
											access.
										</p>
									</div>
								</div>
