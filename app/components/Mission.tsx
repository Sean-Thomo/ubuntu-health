			...
			<div className="w-full px-4">
				<div className="text-center mx-auto mb-[60px] lg:mb-20 max-w-[720px]">
					...
					<p className="text-base text-body-color">
						Our mission is to empower family doctors, general practitioners, and
						small clinics with intuitive and secure EHR software, enabling them
						to deliver exceptional healthcare services while maximizing
